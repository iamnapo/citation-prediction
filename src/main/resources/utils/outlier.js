...
const pairsWithFeatures = fs
	.readFileSync("../pairs_with_features.csv", "utf8")
	.split("\n")
	.slice(1);
...
fs.writeFileSync(
	path.join(__dirname, "../pairs_outliers.txt"),
	pairs_outliers.join("\n")
);
...
fs.writeFileSync(
	path.join(__dirname, "../pairs_cross_validation.txt"),
	pairs_cross_validation.join("\n")
);
